<?php
// source: C:\xampp\htdocs\cviceni03b\app/config/config.neon 
// source: C:\xampp\htdocs\cviceni03b\app/config/config.local.neon 

class Container_999fd45325 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\CompanyFormFactory' => [1 => ['companyform']],
			'App\Forms\EmployerFormFactory' => [1 => ['employerfactory']],
			'App\Forms\PidFormFactory' => [1 => ['pidfactory']],
			'App\Model\BaseModel' => [
				1 => [
					'companymodel',
					'employermodel',
			...
			'App\Model\CompanyModel' => [1 => ['companymodel']],
			'App\Model\EmployerModel' => [1 => ['employermodel']],
			'App\Model\PidModel' => [1 => ['servicepid']],
			'App\Model\StatisticModel' => [1 => ['statisticmodel']],
			'App\Model\UtilityModel' => [1 => ['serviceutility']],
			...
			'App\Presenters\CompanyPresenter' => [1 => ['application.1']],
			'App\Presenters\EmployerPresenter' => [1 => ['application.2']],
			...
			'App\Presenters\PidPresenter' => [1 => ['application.6']],
			'App\Presenters\StatisticPresenter' => [1 => ['application.7']],
			'NetteModule\ErrorPresenter' => [1 => ['application.8']],
			'NetteModule\MicroPresenter' => [1 => ['application.9']],
			'Nette\DI\Container' => [1 => ['container']],
		],
		'services' => [
			'application.1' => 'App\Presenters\CompanyPresenter',
			'application.2' => 'App\Presenters\EmployerPresenter',
			...
			'application.6' => 'App\Presenters\PidPresenter',
			'application.7' => 'App\Presenters\StatisticPresenter',
			...
			'companyform' => 'App\Forms\CompanyFormFactory',
			'companymodel' => 'App\Model\CompanyModel',
			'container' => 'Nette\DI\Container',
			'database.default.connection' => 'Nette\Database\Connection',
			'database.default.context' => 'Nette\Database\Context',
			'database.default.conventions' => 'Nette\Database\Conventions\DiscoveredConventions',
			'database.default.structure' => 'Nette\Database\Structure',
			'employerfactory' => 'App\Forms\EmployerFormFactory',
			'employermodel' => 'App\Model\EmployerModel',
			...
			'pidfactory' => 'App\Forms\PidFormFactory',
			'routing.router' => 'Nette\Application\IRouter',
			'security.user' => 'Nette\Security\User',
			'security.userStorage' => 'Nette\Security\IUserStorage',
			'servicepid' => 'App\Model\PidModel',
			'serviceutility' => 'App\Model\UtilityModel',
			'session.session' => 'Nette\Http\Session',
			'statisticmodel' => 'App\Model\StatisticModel',
			'tracy.bar' => 'Tracy\Bar',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\cviceni03b\app',
			'wwwDir' => 'C:\xampp\htdocs\cviceni03b\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\cviceni03b\app/../temp',
		];
	}


	/**
	 * @return App\Presenters\CompanyPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\CompanyPresenter;
		...
		$service->injectDependencies($this->getService('companyform'), $this->getService('companymodel'));
	...
	/**
	 * @return App\Presenters\EmployerPresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\Presenters\EmployerPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('employerfactory'), $this->getService('companymodel'),
			$this->getService('employermodel'), $this->getService('serviceutility'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	/**
	 * @return App\Presenters\PidPresenter
	 */
	public function createServiceApplication__6()
	{
		$service = new App\Presenters\PidPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\StatisticPresenter
	 */
	public function createServiceApplication__7()
	{
		$service = new App\Presenters\StatisticPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->injectDependencies($this->getService('statisticmodel'));
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\cviceni03b\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\cviceni03b\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\cviceni03b\app/../temp/cache',
	...
	/**
	 * @return App\Forms\CompanyFormFactory
	 */
	public function createServiceCompanyform()
	{
		$service = new App\Forms\CompanyFormFactory;
		$service->injectDependencies($this->getService('companymodel'));
		return $service;
	}


	/**
	 * @return App\Model\CompanyModel
	 */
	public function createServiceCompanymodel()
	{
		$service = new App\Model\CompanyModel($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=cviceni03b', 'root',
			NULL, ['lazy' => TRUE]);
	...
	/**
	 * @return App\Forms\EmployerFormFactory
	 */
	public function createServiceEmployerfactory()
	{
		$service = new App\Forms\EmployerFormFactory;
		$service->injectDependencies($this->getService('employermodel'));
		return $service;
	}


	/**
	 * @return App\Model\EmployerModel
	 */
	public function createServiceEmployermodel()
	{
		$service = new App\Model\EmployerModel($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		return new Container_999fd45325_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	/**
	 * @return App\Forms\PidFormFactory
	 */
	public function createServicePidfactory()
	{
		$service = new App\Forms\PidFormFactory;
		$service->injectDependencies($this->getService('servicepid'));
		return $service;
	}
	...
	/**
	 * @return App\Model\PidModel
	 */
	public function createServiceServicepid()
	{
		$service = new App\Model\PidModel($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\UtilityModel
	 */
	public function createServiceServiceutility()
	{
		$service = new App\Model\UtilityModel($this->getService('database.default.context'));
		$service->setPidService($this->getService('servicepid'));
		return $service;
	}
	...
	/**
	 * @return App\Model\StatisticModel
	 */
	public function createServiceStatisticmodel()
	{
		$service = new App\Model\StatisticModel($this->getService('database.default.context'));
		return $service;
	}
...
class Container_999fd45325_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_999fd45325 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\cviceni03b\app/../temp/cache/latte');
